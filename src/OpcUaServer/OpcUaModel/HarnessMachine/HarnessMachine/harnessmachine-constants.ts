...
export enum ObjectIds {
   ...
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer = 'i=274',
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Identification = 'i=275',
...
export enum VariableIds {
   ...
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Identification_Manufacturer = 'i=282',
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Identification_SerialNumber = 'i=288',
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Identification_DeviceRevision = 'i=291',
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Gripper1 = 'i=292',
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Gripper2 = 'i=293',
   Machines_HarnessMachine_MachineBuildingBlocks_Components_HarnessFormer_Gripper3 = 'i=294',
